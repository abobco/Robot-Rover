...
int main() {
  ...
  servos[0].push_back(xn::pio::SmoothServo(xn::pio::ServoAngular(12, 500, 2500), {0,-1,0}, bonechain[0], 1500 ));
  servos[0].push_back(xn::pio::SmoothServo(xn::pio::ServoAngular(13, 500, 2500), {1, 0,0}, bonechain[0], 1570 ));
  servos[1].push_back(xn::pio::SmoothServo(xn::pio::ServoAngular(26, 500, 2500), {1, 0,0}, bonechain[1], 1420 ));
  servos[2].push_back(xn::pio::SmoothServo(xn::pio::ServoAngular(16, 500, 2500), {1,0,0}, bonechain[2], 1500 ));
